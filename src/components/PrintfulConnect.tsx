...
interface PrintfulConnectProps {
  onSuccess?: () => void;
}

const PrintfulConnect = ({ onSuccess }: PrintfulConnectProps) => {
  ...
  return (
    <Card className="w-full max-w-md mx-auto">
      <CardHeader>
        <CardTitle>Connect to Printful</CardTitle>
        <CardDescription>
          {hasStoredKey
            ? "Your Printful API key is already connected. You can update it below if needed."
...
export default PrintfulConnect;
